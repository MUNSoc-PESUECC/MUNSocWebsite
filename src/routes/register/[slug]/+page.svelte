...
<main>
	<div class="lg:text-6xl text-4xl text-munsoc-gold text-center p-2 m-6">
		Delegate or Delegation ?
	</div>
	<div class="flex flex-col lg:flex-row items-center justify-center m-12 p-4 min-h-[50vh]">
		<a
			...
			href={'https://pages.razorpay.com/UniCon2024-' + data.redirect}>Delegate</a
		>
		<a
			...
			href={'https://pages.razorpay.com/UniCon2024-Delegation'}>Delegation</a
		>
	</div>
</main>
